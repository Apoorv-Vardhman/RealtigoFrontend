...
const ServiceCategory = ()=>{
    ...
    const handleDelete = async (row, index) => {
        ...
        await WebServices.axiosObject(account.token).delete(`service-categories/${row._id}`)
            .then((response) => {
    ...
    return (
        <MainCard title="Service Category">
            <Grid container spacing={2} justifyContent="end" direction="row">
                <Button component={Link} to={{pathname: `/services/categories/create`}}  variant="contained" color="primary">Create Service Category</Button>
            </Grid>
                                    ...
                                    return (
                                        <TableRow  hover role="checkbox" tabIndex={-1} >
                                            ...
                                            <TableCell align="center">
                                                <Button component={Link} to={{pathname: `/services/categories/${row._id}/edit`}}  variant="contained" color="primary">Edit</Button>
