...
const ServiceCategoryEdit = (props)=>{
    ...
    const onSubmit = async data => {
        ...
        setSubmitted(true);
        await WebServices.axiosObject(account.token).put(`service-categories/${props.id}`,formData)
            .then((response) => {
    ...
    const fetchCategory = async ()=>{
        await WebServices.axiosObject(account.token).get(`${configData.API_SERVER}service-categories/${props.id}`)
            .then((response)=>{
