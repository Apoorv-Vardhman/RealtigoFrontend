...
const Services = ()=>{
    ...
    const handleDelete = async (row,index)=>{
        ...
        await WebServices.axiosObject(account.token).delete(`services/${row._id}`)
            .then((response) => {
    ...
    useEffect(()=>{
        try {
            axios
                .get( configData.API_SERVER + 'services', { headers: { Authorization: `Bearer ${account.token}` } })
    ...
    return (
        <MainCard title="Services">
            <Grid container spacing={2} justifyContent="end" direction="row">
                <Button component={Link} to={{pathname: `/services/create`}}  variant="contained" color="primary">Create Service</Button>
            </Grid>
                                    ...
                                    return (
                                        <TableRow  hover role="checkbox" tabIndex={-1} >
                                            ...
                                            <TableCell align="center">
                                                <Button component={Link} to={{pathname: `/services/${row._id}/questions`}} startIcon={<RemoveRedEyeIcon />} variant="contained" color="success">Questions</Button>
                                                <Button component={Link} to={{pathname: `/services/${row._id}/edit`}}  variant="contained" color="primary">Edit</Button>
