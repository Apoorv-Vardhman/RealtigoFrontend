...
const EquipmentQuestionCreate = (props)=>{
    ...
    const onSubmit = async data => {
        ...
        await WebServices.axiosObject(account.token).post("equipment-questions",formData)
            .then((response) => {
    ...
    return (
        <MainCard title="Add new Equipment Question">
...
export default EquipmentQuestionCreate
