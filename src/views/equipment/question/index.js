...
const ServiceQuestion = (props)=>{
    ...
    const handleDelete = async (row, index) => {
        ...
        setRows(tempRows);
        await WebServices.axiosObject(account.token).delete(`equipment-questions/${row._id}`)
            .then((response) => {
    ...
    useEffect(()=>{
        try {
            axios
                .get( configData.API_SERVER + `equipment-questions/${props.id}/question`, { headers: { Authorization: `Bearer ${account.token}` } })
    ...
    return (
        <MainCard title="Equipment Question">

            <Grid container spacing={2} justifyContent="end" direction="row">
                <Button component={Link} to={{pathname: `/equipments/${props.id}/questions/create`}}  variant="contained" color="primary">Create Question</Button>
            </Grid>
                                    ...
                                    return (
                                        <TableRow  hover role="checkbox" tabIndex={-1} >
                                            ...
                                            <TableCell align="center">
                                                {/*/equipments/:id/questions/:question/edit*/}
                                                <Button component={Link} to={{pathname: `/equipments/${props.id}/questions/${row._id}/edit`}}  variant="contained" color="primary">Edit</Button>
