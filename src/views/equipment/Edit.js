...
const EquipmentEdit = (props)=>{
    ...
    const onSubmit = async data => {
        ...
        await WebServices.axiosObject(account.token).put(`equipments/${props.id}`,formData)
            .then((response) => {
    ...
    const fetchEquipment = async ()=>{
        await WebServices.axiosObject(account.token).get(`equipments/${props.id}`)
            .then((response) => {
    ...
    return (
        <MainCard title="Update Equipment">
