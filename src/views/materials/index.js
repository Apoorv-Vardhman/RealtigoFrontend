...
const Material = ()=>{
    ...
    const handleDelete = async (row, index) => {
        ...
        setRows(tempRows);
        await WebServices.axiosObject(account.token).delete(`materials/${row._id}`)
            .then((response) => {
    ...
    return (
        <MainCard title="Materials">
            <Grid container spacing={2} justifyContent="end" direction="row">
                <Button component={Link} to={{pathname: `/materials/create`}}  variant="contained" color="primary">Create Material</Button>
            </Grid>
                                    ...
                                    return (
                                        <TableRow  hover role="checkbox" tabIndex={-1} >
                                            ...
                                            <TableCell align="center">
                                                <Button component={Link} to={{pathname: `/materials/${row._id}/edit`}}  variant="contained" color="primary">Edit</Button>
