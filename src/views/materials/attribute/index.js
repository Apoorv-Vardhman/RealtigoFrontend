...
const Attribute = ()=>{
    ...
    const handleDelete = async (row, index) => {
        ...
        setRows(tempRows);
        await WebServices.axiosObject(account.token).delete(`attributes/${row._id}`)
            .then((response) => {
    ...
    const columns = [
        ...
        { id: 'value', label: 'Values', minWidth: 170 },
        {
            id: 'action',
            label: 'Action ',
            minWidth: 170,
    ...
    return (
        <MainCard title="Attribute Material">
            <Grid container spacing={2} justifyContent="end" direction="row">
                <Button component={Link} to={{pathname: "/attributes/create"}}  variant="contained" color="primary">Create Material Attribute</Button>
            </Grid>
                                    ...
                                    return (
                                        <TableRow  hover role="checkbox" tabIndex={-1} >
                                            ...
                                            <TableCell align="center">
                                                <Button component={Link} to={{pathname: `/attributes/${row._id}/edit`}}  variant="contained" color="primary">Edit</Button>
